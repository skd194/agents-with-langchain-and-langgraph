...
| 5 | [05-rag-and-embeddings.md](05-rag-and-embeddings.md) | RAG overview: why RAG, index/retrieve/generate, chunking, vs alternatives; vectors, similarity, embeddings + code |
